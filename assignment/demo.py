...
print('Constant column index in dataset: %s' % (constant_column))
print('Duplicated column index in dataset: %s' % (sorted(list(set(duplicated_column)))))
delete_column = sorted(list(set(constant_column + duplicated_column)), reverse=True)
print('Columns need to be deleted: %s' % (delete_column))
